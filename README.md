...
**当前状态：v0.2.0 单腿机械 Bring-up 已按修订后验收条件完成。**

两台 DM4310 关节电机和一台 H6215 轮毂电机已装入单腿机构并完成
悬空低速验证。本阶段不代表已完成承重、站立或动力学验证。
...
1. 调查 Disable 瞬间速度样本和跟踪残差，补齐重复循环验证。
2. 建立单腿正运动学与轮轴位置验证，再选定承重姿态。
3. 在支架和低力矩限制下开始受力验证，不直接进入站立或跳跃。
...
| `v0.2.0` | 单腿机械 Bring-up | Stage 完成，待合并发布 |
| `v0.3.0` | 首次站立 | 未开始 |
| `v0.4.0` | 首次行驶 | 未开始 |
| `v0.5.0` | 首次跳跃 | 未开始 |
| `v1.0.0` | 可运行原型 | 未开始 |
